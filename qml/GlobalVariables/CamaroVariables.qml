...
QtObject{
    ...
    property real speed: holleyCan.Input_6
    property bool useKph: false
    property real closedLoopComp: holleyCan.CL_Comp
    property bool showOdometer: false

    property bool overDrive: racepakCan.Output_13_Amps > 0.1
    property bool parkNeutral: false
    property bool fanState: racepakCan.Output_30_Amps > 0.1
    property bool leftTurnState: racepakCan.Output_17_Amps > 0.1
    property bool rightTurnState: racepakCan.Output_12_Amps > 0.1
    property bool highbeamIndicatorState: racepakCan.Output_8_Amps > 0.1
    property bool reverse: racepakCan.Output_16_Amps > 0.1
